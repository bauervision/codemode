...
export default function ProjectWizard({ onLaunch }: { onLaunch: (name: string) => void }) {
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-10 shadow-xl w-[95vw] max-w-lg text-center relative">
          ...
          {step === "webName" && (
            <div className="flex flex-col items-center gap-6">
              <div className="font-bold text-lg text-left w-full mb-2">Project Name:</div>
              <input
          ...
          {step === "summary" && (
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="bg-zinc-800 rounded-lg p-4 w-full mb-2 text-left">
                <div className="text-sm text-zinc-400 mb-2">Terminal Command:</div>
                <pre className="text-cyan-300 bg-zinc-900 rounded px-2 py-2 text-xs select-all">
